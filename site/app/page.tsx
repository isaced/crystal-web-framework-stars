  ...
  return (
    <main className="py-10 px-3 sm:px-8 lg:px-10 xl:px-20">
      <h1 className="text-5xl flex items-center space-x-2">
        <Image src="/crystal-logo.png" alt={"Crystal Logo"} width={46} height={46} className=" h-fit" />
      ...
      <div className="relative overflow-x-auto mt-10 space-y-3">
        {data?.map((repo, idx) => (
          ...
          >
            <div className={`w-20 text-2xl font-bold text-center tracking-tight ${StarColors[idx] ?? "text-gray-900"}`}>
            ...
            <div>
              <div className="flex items-center space-x-3">
                ...
                <div className="text-gray-500 text-xs space-x-3">
                  <span>{dayjs.default(repo.last_commit_date).format("LL").toString()}</span>
